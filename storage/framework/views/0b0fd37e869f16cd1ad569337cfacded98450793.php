    ...
    <section class="home">
        <div class="container clearfix">
            ...
            <form class="search_user">
                ...
                <input type="text" placeholder="Введите имя пользователя" id="inputForSearchClients" name="search" value="<?php echo e($search); ?>">
            ...
            <div class="main_all_user">
                            ...
                            <div class="item_user <?php if($client->end_date && strtotime($client->end_date) > strtotime(Date::now()) + 259200): ?> active <?php endif; ?> <?php if($client->end_date && strtotime($client->end_date) <= strtotime(Date::now()) + 259200): ?> ended <?php endif; ?>" data-client_id=<?php echo e($client->id); ?> data-login=<?php echo e($client->login); ?> data-parol=<?php echo e($client->parol); ?> data-server=<?php echo e($client->server); ?>
                                ...
                                <div class="item btn_item">
                                    ...
                                    <div class="all_action">
                                        ...
                                        <a href="<?php echo e(route('diller.buyPaket', $client->id)); ?>">Купить</a>
                ...
                <div class="notted_single">
                    <select class="selectForAllClients">
                        <option value="1" <?php echo e(isset($data[1]) ? 'disabled' : ''); ?>>#1СЕРВЕР</option>
                        <option value="2" <?php echo e(isset($data[2]) ? 'disabled' : ''); ?>>#2СЕРВЕР</option>
                        <option value="3" <?php echo e(isset($data[3]) ? 'disabled' : ''); ?>>#3СЕРВЕР</option>
                        <option value="4" <?php echo e(isset($data[4]) ? 'disabled' : ''); ?>>#4СЕРВЕР</option>
                        <option value="5" <?php echo e(isset($data[5]) ? 'disabled' : ''); ?>>#5СЕРВЕР</option>
                        <option value="6" <?php echo e(isset($data[6]) ? 'disabled' : ''); ?>>#6СЕРВЕР</option>
                        <option value="7" <?php echo e(isset($data[7]) ? 'disabled' : ''); ?>>#7CЕРВЕР</option>
                        <option value="8" <?php echo e(isset($data[8]) ? 'disabled' : ''); ?>>#8СЕРВЕР</option>
                        <option value="9" <?php echo e(isset($data[9]) ? 'disabled' : ''); ?>>#9СЕРВЕР</option>
                    </select>
    ...
    <div class="profile_edit">
        ...
        <form action="#" method="post" class="form_add_client">
            ...
            <label>
                ...
                <select name="server">
                    <option value=""></option>
                    <option value="1" <?php echo e(isset($data[1]) ? 'disabled' : ''); ?>>Туркменистан s1.tmsat.live</option>
                    <option value="2" <?php echo e(isset($data[2]) ? 'disabled' : ''); ?>>Туркменистан s2.tmsat.live</option>
                    <option value="3" <?php echo e(isset($data[3]) ? 'disabled' : ''); ?>>Туркменистан s3.tmsat.live</option>
                    <option value="4" <?php echo e(isset($data[4]) ? 'disabled' : ''); ?>>Туркменистан s4.tmsat.live</option>
                    <option value="5" <?php echo e(isset($data[5]) ? 'disabled' : ''); ?>>Туркменистан s5.tmsat.live</option>
                    <option value="6" <?php echo e(isset($data[6]) ? 'disabled' : ''); ?>>Туркменистан s6.tmsat.live</option>
                    <option value="7" <?php echo e(isset($data[7]) ? 'disabled' : ''); ?>>Туркменистан s7.tmsat.live</option>
                    <option value="8" <?php echo e(isset($data[8]) ? 'disabled' : ''); ?>>Туркменистан s8.tmsat.live</option>
                    <option value="9" <?php echo e(isset($data[9]) ? 'disabled' : ''); ?>>Туркменистан s9.tmsat.live</option>
                </select>
            </label>
            <label>
