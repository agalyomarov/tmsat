        ...
        <div class="container clearfix">
            ...
            <div class="main_pay" style="padding-top:40px">
                ...
                <div style="width:100%;text-align:center;margin:0 auto;margin-top:20px">
                    <p style="margin-bottom:5px;color:white">Для пользователя <?php echo e($client->login); ?></p>
                </div>
                ...
                <div style="width:240px;text-align:center;margin:0 auto;margin-top:20px !important">
                    <input type="button" class="btn_pay btn_for_buy_paket" value="Купить" style="font-size:15px;font-weight:bold;margin:0 auto !important;" data-client_id="<?php echo e($client->id); ?>">
                </div>
            </div>
        </div>
        </div>
...
<?php /**PATH /Users/agaly/Desktop/tmsat/resources/views/pay.blade.php ENDPATH**/ ?>